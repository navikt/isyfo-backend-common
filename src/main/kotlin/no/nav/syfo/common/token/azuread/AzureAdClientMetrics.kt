...
internal val COUNT_CALL_AZUREAD_SYSTEM_TOKEN_CACHE_HIT: Counter by lazy {
    Counter.builder("${metricsAppPrefix}_${CALL_AZUREAD_SYSTEM_TOKEN_CACHE_BASE}_hit_count")
...
internal val COUNT_CALL_AZUREAD_SYSTEM_TOKEN_CACHE_MISS: Counter by lazy {
    Counter.builder("${metricsAppPrefix}_${CALL_AZUREAD_SYSTEM_TOKEN_CACHE_BASE}_miss_count")
