...
internal val COUNT_CALL_AZUREAD_SYSTEM_TOKEN_CACHE_HIT: Counter = Counter.builder("${CALL_AZUREAD_SYSTEM_TOKEN_CACHE_BASE}_hit_count")
    .description("Counts the number of cache hits for calls to Azure AD for a system token")
    .register(Metrics.globalRegistry)

internal val COUNT_CALL_AZUREAD_SYSTEM_TOKEN_CACHE_MISS: Counter = Counter.builder("${CALL_AZUREAD_SYSTEM_TOKEN_CACHE_BASE}_miss_count")
