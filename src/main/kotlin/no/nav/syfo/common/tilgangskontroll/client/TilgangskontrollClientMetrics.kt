...
internal val COUNT_CALL_TILGANGSKONTROLL_PERSON_SUCCESS: Counter by lazy {
    Counter.builder("${metricsAppPrefix}_${CALL_TILGANGSKONTROLL_PERSON_BASE}_success_count")
...
internal val COUNT_CALL_TILGANGSKONTROLL_PERSON_FAIL: Counter by lazy {
    Counter.builder("${metricsAppPrefix}_${CALL_TILGANGSKONTROLL_PERSON_BASE}_fail_count")
...
internal val COUNT_CALL_TILGANGSKONTROLL_PERSON_FORBIDDEN: Counter by lazy {
    Counter.builder("${metricsAppPrefix}_${CALL_TILGANGSKONTROLL_PERSON_BASE}_forbidden_count")
